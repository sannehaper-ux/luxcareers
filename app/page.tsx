...
export default function HomePage() {
  ...
  const goApply = () => router.push('/apply');
      ...
      <header className="sticky top-0 z-50 bg-white border-b border-sky-border shadow-sm">
        <div className="max-w-6xl mx-auto px-5 flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center gap-8">
            {NAV_LINKS.map(l => (
              <a key={l.label} href={l.href} className="text-sm font-medium text-navy-700 hover:text-gold-400 transition-colors">
                {l.label}
              </a>
            ))}
          </nav>
        ...
        {menuOpen && (
          <div className="md:hidden border-t border-sky-border bg-white px-5 py-4 space-y-3">
            ...
            <button
              onClick={() => { goApply(); setMenuOpen(false); }}
      ...
      <section className="bg-navy-700 text-white">
        <div className="max-w-6xl mx-auto px-5 py-16 lg:py-20 grid lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <h1 className="text-4xl sm:text-5xl font-extrabold leading-tight mb-5" style={{ fontFamily: "'Poppins', sans-serif" }}>
              Find a Real Job<br />
              and Move to<br />
            ...
            <a href="#how-it-works" className="inline-flex items-center gap-1.5 text-white/60 hover:text-white text-sm transition-colors">
      ...
      <section id="how-it-works" className="py-20 bg-sky-light border-t border-sky-border">
        <div className="max-w-6xl mx-auto px-5">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold text-navy-700" style={{ fontFamily: "'Poppins', sans-serif" }}>How it works</h2>
        ...
        <div className="max-w-6xl mx-auto px-5 grid lg:grid-cols-2 gap-14 items-start">
          ...
          <div className="space-y-5 mt-0 lg:mt-10">
            <div className="bg-amber-50 border border-amber-200 rounded-2xl p-6">
              <h3 className="font-semibold text-amber-900 mb-2 text-sm" style={{ fontFamily: "'Poppins', sans-serif" }}>About the Immigration Fee</h3>
            ...
            <div className="bg-sky-light border border-sky-border rounded-2xl p-6">
              <h3 className="font-semibold text-navy-700 mb-2 text-sm" style={{ fontFamily: "'Poppins', sans-serif" }}>Important</h3>
            ...
            <div className="bg-navy-50 border border-navy-100 rounded-2xl p-6">
              <h3 className="font-semibold text-navy-700 mb-2 text-sm" style={{ fontFamily: "'Poppins', sans-serif" }}>Not sure? Just ask us</h3>
              <p className="text-navy-500 text-sm leading-relaxed">
      ...
      <section id="contact" className="py-20 bg-white border-t border-sky-border">
        <div className="max-w-6xl mx-auto px-5">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold text-navy-700" style={{ fontFamily: "'Poppins', sans-serif" }}>Talk to Us</h2>
