...
export default function SuccessContent({ applicationId }: Props) {
  ...
  return (
    <div className="min-h-screen bg-sky-light flex flex-col items-center justify-center px-4 py-16" style={{ fontFamily: "'Open Sans', sans-serif" }}>
