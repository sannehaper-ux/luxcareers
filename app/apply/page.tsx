...
const CENTERS = [
  "",
  "Luxembourg City â€” Main Immigration Office",
  "Esch-sur-Alzette â€” Regional Center",
  "Differdange â€” Service Point",
  "Dudelange â€” Processing Unit",
  "Ettelbruck â€” North Regional Center",
  "Diekirch â€” Administrative Hub",
    ...
    >
      <div className="sticky top-0 z-10 bg-white border-b border-sky-border shadow-sm">
        <div className="max-w-3xl mx-auto px-4 h-14 flex items-center gap-3">
          ...
          <span className="text-navy-400 text-sm ml-auto hidden sm:block">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Section num="3" title="Nationality / Citizenship">
            <div>
              ...
              <TextInput
                placeholder="e.g. Indian, Filipino, Nigerian..."
          ...
          <Section
            ...
            note="If any â€” leave blank if none"
          >
            <div>
              <Label text="Previous Employment" />
              <Textarea
                placeholder={
                  "e.g.\n2019â€“2022: Driver, XYZ Transport, Lagos\n2022â€“2024: Warehouse Staff, Dubai"
                }
          ...
          <Section num="7â€“8" title="Work Experience & Education">
            <div>
            ...
            <div>
              ...
              <Textarea
                placeholder={
                  "e.g.\nBSc Engineering â€” University of Lagos (2017)\nDiploma in Healthcare â€” Nairobi College (2019)"
                }
          ...
          <Section num="11" title="Travel History" note="If any">
            <div>
              ...
              <Textarea
                placeholder={
                  "e.g.\n2021: UAE (Dubai) â€” Work\n2023: South Africa (Cape Town) â€” Tourism"
                }
